...
class WhatsAppBookingAgencyTransaction implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $data = [
            ...
            'sender' => $token->sender,
            'number' => $telepon,
            'message' => "Terima Kasih *$sapaanAgency $namaAgency*\n\nPembayaran *BOOKING* Konsumen kamu yang bernama *$sapaanMember $namaMember* telah Dikonfirmasi.\n\n*$kategori*\nInvoice: *$invoice*\nProject: *$kavling*\nBlok: *$blok*\nBiaya Booking: Rp *$biaya*\nStatus: *$status*\n\nSatu langkah lagi untuk mereka *CLOSING*\n\nMohon untuk membantu Konfirmasikan kepada konsumen untuk segera melakukan pembayaran DP Pertama.\n\n*Terima Kasih*",
        ];
