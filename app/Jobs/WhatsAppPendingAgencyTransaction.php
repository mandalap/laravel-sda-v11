...
class WhatsAppPendingAgencyTransaction implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $data = [
            ...
            'sender' => $token->sender,
            'number' => $telepon,
            'message' => "Selamat *$sapaanAgency $namaAgency*\n\nKonsumen kamu yang atas nama *$sapaanMember $namaMember* telah melakukan transaksi *BOOKING*.\n\n*$kategori*\nInvoice: *$invoice*\nProject: *$kavling*\nBlok: *$blok*\nBiaya Booking: Rp *$biaya*\nStatus: *$status*\n\nMohon untuk membantu Konfirmasikan kepada konsumen Anda untuk segera melakukan pembayaran booking.\n\n*Terima Kasih*",
        ];
