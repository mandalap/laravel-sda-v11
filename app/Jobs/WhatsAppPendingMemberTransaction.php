...
class WhatsAppPendingMemberTransaction implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $data = [
            ...
            'sender' => $token->sender,
            'number' => $telepon,
            'message' => "Selamat *$sapaanMember $namaMember*\n\n*Booking* $kategori Anda *Berhasil*.\n\n*$kategori*\nInvoice: *$invoice*\nProject: *$kavling*\nBlok: *$blok*\nBiaya Booking: Rp *$biaya*\nStatus: *$status*\n\nTransfer booking bisa melalui:\nBank BCA\nNo Rekening: 6465364797\nA.n. *RIIL SYARIAH INDONESIA*\n\n*Batas pembayaran Booking selama 7 hari*. Jika tidak membayar, maka secara otomatis produk yang dibooking akan terbuka kembali.\n\n*Silahkan upload bukti pembayaran disini agar terdata secara resmi di siteplan project*\n\nSimpan nomor ini dengan nama *Admin Sajada Digital Agency*",
        ];
