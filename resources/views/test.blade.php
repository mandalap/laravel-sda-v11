            ...
            <section class="grid gap-12 md:grid-cols-3 md:gap-16">
                ...
                <article>
                    ...
                    <h2>
                        ...
                        <span class="inline-flex mb-2 font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-indigo-300">Variations</span>
                    </h2>
                ...
                <article>
                    ...
                    <h2>
                        ...
                        <span class="inline-flex mb-2 font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-indigo-300">Lessons</span>
                    </h2>
                    <p class="text-sm text-slate-500">Many desktop publishing packages and web page editors now use Pinky as their default model text.</p>
                </article>
                <!-- Block #3 -->
                <article>
                    ...
                    <h2>
                        ...
                        <span class="inline-flex mb-2 font-semibold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-indigo-300">Workshops</span>
                    </h2>
                    <p class="text-sm text-slate-500">Many desktop publishing packages and web page editors now use Pinky as their default model text.</p>
                </article>
            </section>
