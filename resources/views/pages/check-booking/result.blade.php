...
@section('content')
    ...
    <div
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            <div class="flex justify-between items-center">
                <div class="flex gap-3 items-center">
                    <img src="{{ asset('assets/images/icons/invoice.svg') }}" class="flex w-6 h-6 shrink-0" alt="icon">
            ...
            <div class="flex justify-between items-center">
                <div class="flex gap-3 items-center">
                    <img src="{{ asset('assets/images/icons/timer.svg') }}" class="flex w-6 h-6 shrink-0" alt="icon">
