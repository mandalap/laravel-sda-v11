                        ...
                        @if (!$is_referral)
                            <div class="mt-2 p-3 bg-blue-50 border-l-4 border-blue-400 rounded">
                                <p class="text-sm text-blue-700">
                                    ...
                                    Jika Anda memiliki kode referral dari Agency, masukkan di sini untuk mendapatkan benefit
                                    khusus.
                                </p>
                            </div>
                        @else
...
@push('addon-script')
    <script>
        // Auto-uppercase kode referral jika tidak readonly
        const referralInput = document.getElementById('referral_code');
        if (!referralInput.readOnly) {
