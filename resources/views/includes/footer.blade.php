        ...
        <div
            ...
            <a href="{{ route('beranda') }}" class="flex flex-col gap-2 items-center text-center group">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none"
                    class="{{ request()->routeIs('beranda') ? 'text-white' : 'text-custom-gray-10 opacity-80 group-hover:text-black' }}">
                    <path
                ...
                <span
                    class="text-xs {{ request()->routeIs('beranda') ? 'font-bold text-white' : 'text-custom-gray-10 opacity-80 font-medium group-hover:text-black' }}">Beranda</span>
            </a>

            <!-- Booking -->
            <a href="{{ route('check-booking') }}" class="flex flex-col gap-2 items-center text-center group">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none"
                    class="{{ request()->routeIs('check-booking') ? 'text-white' : 'text-custom-gray-10 opacity-80 group-hover:text-black' }}">
                    <path
                ...
                <span
                    class="text-xs {{ request()->routeIs('check-booking') ? 'font-bold text-white' : 'font-medium text-custom-gray-10 opacity-80 group-hover:text-black' }}">Booking</span>
            </a>

            <!-- Cari Properti -->
            <a href="{{ route('cari-properti') }}" class="flex flex-col gap-2 items-center text-center group">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none"
                    class="{{ request()->routeIs('cari-properti') ? 'text-white' : 'text-custom-gray-10 opacity-80 group-hover:text-black' }}">
                    <path
                ...
                <span
                    class="text-xs {{ request()->routeIs('cari-properti') ? 'font-bold text-white' : 'font-medium text-custom-gray-10 opacity-80 group-hover:text-black' }}">Cari</span>
            </a>
            <a href="{{ route('profil') }}" class="flex flex-col gap-2 items-center text-center group">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none"
                    class=" {{ request()->routeIs('profil') ? 'text-white' : 'text-custom-gray-10 opacity-80 group-hover:text-black' }}">
                    <path
                ...
                <span
                    class="text-xs {{ request()->routeIs('profil') ? 'font-bold text-white' : 'font-medium text-custom-gray-10 opacity-80 group-hover:text-black' }}">Akun</span>
            </a>
        </div>
    </nav>
</div>
